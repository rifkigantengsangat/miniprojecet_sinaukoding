    ...
    <div class="w-100 shadow p-4"> 
        <div class="w-100 pb-2 ">
            ...
            <div class="d-flex justify-content-between">
             <h5>Barang</h5>
             <router-link to="/tambahbarang" class="btn btn-success">Tambah Barang</router-link>
            </div>
        </div>
            ...
            <tbody>
              <tr v-for="(data,index) in getData" :key="index">
                ...
                <th>{{data.namaBarang}}</th>
                    ...
                    <th><button @click="deleteData(data.id)" class="btn btn-danger">Hapus</button> <router-link :to="`/barang/${data.id}`" class="btn btn-warning">Update</router-link></th>
              </tr>
